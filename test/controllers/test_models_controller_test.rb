...
class TestModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_model" do
    assert_difference('TestModel.count') do
      post test_models_url, params: { test_model: { text: @test_model.text, title: @test_model.title } }
    end
  ...
  test "should update test_model" do
    patch test_model_url(@test_model), params: { test_model: { text: @test_model.text, title: @test_model.title } }
